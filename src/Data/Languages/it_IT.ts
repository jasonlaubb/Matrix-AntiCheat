...
export default {
    ...
    ".Spam.repeated": "Non è possibile inviare per più volte lo stesso messaggio",
    ".Spam.kicked": "§c%a§g è stato kikkato con successo per la seguente motivazione: spam",
    ".Spam.filter": "Il tuo messaggio contiene una parola filtrata",
    ".Spam.long": "Il messaggio che hai provato ad inviare è troppo lungo",
    ".Spam.blacklist": "Avviso, nel messaggio che hai inviato, c'è una parola contenuta nella lista nera",
    ".Spam.kickedBlacklist": "§c%a§g è stato kikkato con successo per la seguente motivazione: ha inviato un messaggio con all'interno una parola contenuta nella lista nera",
    ...
    ".Util.operator": "By",
    ".Bot.by": "(Azione difensiva dai bot)",
    ".Spam.by": "(Azione automatica anti spam)",
    ".Spam.spamming": "Spam in chat",
    ".Spam.blacklisted": "Messaggio nella lista nera",
    ".Bot.waitUI": "Per una questione di sicurezza, non puoi usare la chat fino alla fine del processo di verifica. Perfavore aspetta fino a quando non ti esce il pannello di verifica",
    ".Bot.expired": "Verifica scaduta",
    ".Bot.ui": "§a[Questo server è protetto dal Matrix AntiCheat]\n§gTi devi verificare se non sei un bot §7(%a/%b)§g\nHai ancora §e%c§gsecondi\nInserisci il codice §e§l%d§r§g qui in basso",
    ".Bot.title": "Verifica Anti Bot",
    ".Bot.failed": "Verifica fallita",
    ".Bot.ok": "Ti sei verificato con successo",
    ...
    "-borderSize.enter": "Perfavore inserisci una misura per il bordo.",
    "-borderSize.notANum": "Non è un numero!",
    "-borderSize.between": "La misura del bordo deve essere compreso tra 100 e 1M!",
    "-borderSize.ok": "è stata cambiata la misura del bordo con successo in %a",
    "-help.borderSize": "borderSize <misura/dibase> - Cambia la misura del bordo del mondo",
    ".UI.exit": "Esci",
    ".UI.i": "Admin GUI",
    ".UI.i.a": "Modera i giocatori",
    ".UI.i.b": "Impostazioni",
};
