...
export const lang = (key: LangType): string => langs[languageNow][key] ?? "[Langauge not found]"
...
| ".UI.exit" | ".UI.i" | ".UI.i.a" | ".UI.i.b" | "-borderSize.ok" | ".Util.by" | ".Util.operator" | "-help.borderSize"