...
world.beforeEvents.chatSend.subscribe((data) => {
  ...
  if(msg.startsWith(prefix + "freeze") && player.hasTag("MatrixOP")) {
    if(target == checkExistPlayer) {
      ...
      system.run(() => {
        world.sendMessage(
          `§e[§cMatrix§e] §b${target} §chas been frozen \n§gBy§8:§b${player.name}\n§gReason§8:§c${reason}`)
...
world.beforeEvents.chatSend.subscribe((data) => {
  ...
  if(msg.startsWith(prefix + "mute") && player.hasTag("MatrixOP")) {
    if(target == checkExistPlayer) {
      ...
      system.run(() => {
        world.sendMessage(
          `§e[§cMatrix§e] §b${target} §chas been muted \n§gBy§8:§b${player.name}\n§gReason§8:§c${reason}`)
...
world.beforeEvents.chatSend.subscribe((data) => {
  ...
  if(msg.startsWith(prefix + "ban") && player.hasTag("MatrixOP")) {
    if(target == checkExistPlayer) {
      ...
      system.run(() => {
        world.sendMessage(
          `§e[§cMatrix§e] §b${target} §chas been banned from server\n§gBy§8:§b${player.name}\n§gReason§8:§c${reason}`
          )
  ...
  if(msg.startsWith(prefix + "kick") && player.hasTag("MatrixOP")) {
    if(target == checkExistPlayer) {
      ...
      system.run(() => {
        world.sendMessage(
          `§e[§cMatrix§e] §b${target} §chas been kicked from server\n§gBy§8:§b${player.name}\n§gReason§8:§c${reason}`
          )
        player.runCommand(
