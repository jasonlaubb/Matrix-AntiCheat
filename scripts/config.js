...
let toolsNames = ["minecraft:netherite_hoe", "minecraft:golden_hoe", "minecraft:diamond_hoe",
...
let stoneTools = ["minecraft:stone_hoe", "minecraft:stone_shovel", "minecraft:stone_axe", "minecraft:stone_pickaxe"]
let woodTools = ["minecraft:wooden_hoe", "minecraft:wooden_shovel", "minecraft:wooden_axe", "minecraft:wooden_pickaxe"]
//*list of xray blocks 
let xray = ["minecraft:diamond_ore", "minecraft:deepslate_diamond_ore", "minecraft:emerald_ore",
