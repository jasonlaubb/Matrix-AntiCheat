...
world.beforeEvents.chatSend.subscribe((data) => {
  ...
  if(msg.startsWith(prefix + "freeze") && player.hasTag("MatrixOP")) {
    if(target == checkExistPlayer) {
      system.run(() => {
        new moderateAction(target, player).freeze(word[2].replaceAll(`"`).trim(), world.getPlayers({ name: target }).location)
      })
    }
    if(target != checkExistPlayer) {
      system.run(() => {
...
world.beforeEvents.chatSend.subscribe((data) => {
  ...
  if(msg.startsWith(prefix + "mute") && player.hasTag("MatrixOP")) {
    if(target == checkExistPlayer) {
      system.run(() => {
        new moderateAction(target, player).mute(word[2].replaceAll(`"`).trim())
      })
    }
    if(target != checkExistPlayer) {
      system.run(() => {
  ...
  if(msg.startsWith(prefix + "notify") && player.hasTag("MatrixOP")) {
    if(target == checkExistPlayer) {
      system.run(() => {
        world.sendMessage(
          `§e[§cMatrix§e] §b${target} §ahas been put for get cheats notification\n§gBy§8:§b${player.name}`)
  ...
  if(msg.startsWith(prefix + "xray_notify") && player.hasTag("MatrixOP")) {
    if(target == checkExistPlayer) {
      system.run(() => {
        world.sendMessage(
          `§e[§cMatrix§e] §b${target} §ahas been put for get xray notification\n§gBy§8:§b${player.name}`)
  ...
  if(msg.startsWith(prefix + "unnotify") && player.hasTag("MatrixOP")) {
    if(target == checkExistPlayer) {
      system.run(() => {
        world.sendMessage(
          `§e[§cMatrix§e] §b${target} §chas been removed from get cheats notification\n§gBy§8:§b${player.name}`
          )
  ...
  if(msg.startsWith(prefix + "unmute") && player.hasTag("MatrixOP")) {
    if(target == checkExistPlayer) {
      system.run(() => {
        new moderateAction(target, player).unmute()
      })
    }
    if(target != checkExistPlayer) {
      system.run(() => {
  ...
  if(msg.startsWith(prefix + "xray_unnotify") && player.hasTag("MatrixOP")) {
    if(target == checkExistPlayer) {
      system.run(() => {
        world.sendMessage(
          `§e[§cMatrix§e] §b${target} §chas been removed from get xray notification\n§gBy§8:§b${player.name}`)
  ...
  if(msg.startsWith(prefix + "unban") && player.hasTag("MatrixOP")) {
    system.run(() => {
      new moderateAction(target, player).unban()
    })
  }
  if(msg.startsWith(prefix + "unfreeze") && player.hasTag("MatrixOP")) {
    if(target == checkExistPlayer) {
      system.run(() => {
        new moderateAction(target, player).unfreeze()
      })
    }
    if(target != checkExistPlayer) {
      system.run(() => {
  ...
  if(msg.startsWith(prefix + "rank") && player.hasTag("MatrixOP")) {
    ...
    if(target == checkExistPlayer || Rank != "null") {
      system.run(() => {
        if(Rank == "null") return
        world.sendMessage(
          `§e[§cMatrix§e] §b${target} §ahis rank has been changed\n§gBy§8:§b${player.name}\n§gRank§8:§r${Rank}`
          )
...
world.beforeEvents.chatSend.subscribe((data) => {
  ...
  if(msg.startsWith(prefix + "ban") && player.hasTag("MatrixOP")) {
    if(target == checkExistPlayer) {
      system.run(() => {
        new moderateAction(target, player).ban(word[2].replaceAll(`"`).trim())
      })
    }
    if(target != checkExistPlayer) {
      system.run(() => {
  ...
  if(msg.startsWith(prefix + "kick") && player.hasTag("MatrixOP")) {
    if(target == checkExistPlayer) {
      ...
      system.run(() => {
        new moderateAction(target, player)
      })
    }
    if(target != checkExistPlayer) {
      system.run(() => {
  ...
  if(msg.startsWith(prefix + "itemCheck")) {
    if(target == checkExistPlayer) {
      ...
      for(let i = 0; i < inventory.size; i++) {
        ...
        if(item == itemSearch) {
          player.sendMessage(
            `§g[§cMatrix§g] §aSuccessfully found §8(§g${itemSearch}§8) §gamount §8(§g${amount}§8) §gin slot §8(§g${i}§8)`
            )
        }
      }
    }
