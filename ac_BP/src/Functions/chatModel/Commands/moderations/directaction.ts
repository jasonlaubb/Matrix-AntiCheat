...
registerCommand({
    ...
    executor: async (player, _args) => {
        ...
        const form = new ActionFormData().title("Direct Action Selector").body("In this ui, section sign or quotation marks won't affect you to do the action to the selected player.");
